...
- Migrate your plugin database scheme using <tt>redmine:plugins:migrate RAILS_ENV="production"</tt>
- Restart Redmine
...
through <tt>http://redmine.url/roles/permissions</tt> under the "Newissuealerts" section.
